...
return [
    ...
    'thread.close'           => 'Fermer',
    'thread.sticky'          => 'Épingler',
    'thread.unsticky'        => 'Désépingler',
    ...
    'post.error_duplicate'       => 'Vous avez déjà publié ce message récemment.',
    ...
    'auth.pending_approval_title' => 'En attente d\'approbation du modérateur',
    ...
    'profile.continue_browsing' => 'Continuer la navigation : {forum}',
    ...
    'sub.forum_title' => 'Suivre le forum',
    'sub.forum_following_email' => 'Vous suivez actuellement ce forum et recevrez des notifications par e-mail pour les nouveaux sujets et réponses.',
    'sub.forum_bookmarked' => 'Vous avez mis ce forum en favori (pas de notifications par e-mail).',
    'sub.forum_not_following' => 'Vous ne suivez pas ce forum.',
    'sub.back_to_forum' => 'Retour au forum',
    'sub.confirm_remove_forum' => 'Voulez-vous vraiment vous désabonner de ce forum ?',
    'sub.confirm_bookmark_forum' => 'Basculer votre abonnement au forum vers un favori (pas de notifications par e-mail) ?',
    ...
    'mod.sticky_thread'            => 'Épingler le fil',
    'mod.unsticky_thread'          => 'Désépingler le fil',
    'mod.sticky_confirm'           => 'Épingler le fil « {subject} » ? Il sera affiché en haut de la liste du forum.',
    'mod.unsticky_confirm'         => 'Désépingler « {subject} » ? Il reviendra à l\'ordre de tri normal.',
    'mod.yes_delete'               => 'Oui, supprimer',
    'mod.approve'                  => 'Approuver',
    'mod.close'                    => 'Fermer le fil',
    'mod.reopen'                   => 'Rouvrir le fil',
    'mod.sticky'                   => 'Épingler',
    'mod.unsticky'                 => 'Désépingler',
    'mod.cancel'                   => 'Annuler',
    ...
    'mod.users_queue'              => 'Utilisateurs en attente',
    'mod.users_queue_title'        => 'Approbations d\'utilisateurs en attente',
    'mod.users_queue_empty'        => 'Aucun compte n\'est en attente d\'approbation du modérateur.',
    'mod.users_queue_username'     => 'Nom d\'utilisateur',
    'mod.users_queue_email'        => 'E-mail',
    'mod.users_queue_ip'           => 'Adresse IP',
    'mod.users_queue_registered'   => 'Inscrit',
    'mod.users_queue_approve'      => 'Approuver',
    'mod.users_queue_reject'       => 'Rejeter',
