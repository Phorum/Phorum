...
return [
    ...
    'auth.pending_approval_title' => '等待管理員審核',
    ...
    'mod.sticky_thread'            => '置頂主題',
    'mod.unsticky_thread'          => '取消置頂主題',
    'mod.sticky_confirm'           => '將主題「{subject}」置頂？它將被固定在論壇列表頂部。',
    'mod.unsticky_confirm'         => '取消主題「{subject}」的置頂？它將恢復正常排序。',
    'mod.yes_delete'               => '確認刪除',
    'mod.approve'                  => '核准',
    'mod.close'                    => '關閉主題',
    'mod.reopen'                   => '重新開放主題',
    ...
    'mod.users_queue'              => '待審使用者',
    'mod.users_queue_title'        => '待審使用者核准',
    'mod.users_queue_empty'        => '沒有帳號正在等待版主核准。',
    'mod.users_queue_username'     => '使用者名稱',
    'mod.users_queue_email'        => '電子郵件',
    'mod.users_queue_ip'           => 'IP 位址',
    'mod.users_queue_registered'   => '註冊時間',
    'mod.users_queue_approve'      => '核准',
    'mod.users_queue_reject'       => '拒絕',
    'report.title'                 => '檢舉文章',
