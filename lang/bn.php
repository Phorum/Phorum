...
return [
    ...
    'post.error_duplicate'       => 'আপনি সম্প্রতি এই বার্তাটি ইতিমধ্যে পোস্ট করেছেন।',

    // -------------------------------------------------------------------------
    // Authentication
    // -------------------------------------------------------------------------
    'auth.login_title'      => 'লগ ইন',
    'auth.logout_title'      => 'লগ আউট',
    'auth.logout_confirm'      => 'আপনি কি নিশ্চিত যে আপনি লগ আউট করতে চান?',
    'auth.logout_submit'      => 'লগ আউট',
    'auth.logout_already'      => 'আপনি লগ ইন করা নেই।',
    ...
    'auth.confirm_success_login'        => 'আপনার ইমেল ঠিকানা নিশ্চিত করা হয়েছে। অনুগ্রহ করে লগ ইন করুন।',
    ...
    'auth.error_throttled'  => 'অত্যধিক চেষ্টা। অনুগ্রহ করে {seconds} সেকেন্ড অপেক্ষা করে আবার চেষ্টা করুন।',
    ...
    'auth.error_email_taken'       => 'এই ইমেল ঠিকানাটি ইতিমধ্যে নিবন্ধিত। লগ ইন করার চেষ্টা করুন, অথবা "পাসওয়ার্ড ভুলে গেছেন" ব্যবহার করুন।',
    ...
    'oauth.error_account_exists'      => 'এই সাইটে ইতিমধ্যেই একটি অ্যাকাউন্ট এই ইমেল ঠিকানা ব্যবহার করছে। আপনার পাসওয়ার্ড দিয়ে সাইন ইন করুন, অথবা প্রথমে ঠিকানাটি নিশ্চিত করতে "পাসওয়ার্ড ভুলে গেছেন" ব্যবহার করুন — তারপর আপনি এই প্রদানকারী ব্যবহার করতে পারবেন।',
    ...
    'profile.continue_browsing' => 'ব্রাউজিং চালিয়ে যান: {forum}',
    ...
    'settings.current_password_hint'      => 'শুধুমাত্র পাসওয়ার্ড বা ইমেল ঠিকানা পরিবর্তনের সময় প্রয়োজন।',
    ...
    'settings.error_current_password'   => 'পাসওয়ার্ড বা ইমেল ঠিকানা পরিবর্তন করতে আপনার বর্তমান পাসওয়ার্ড লিখুন। আপনি যদি Google বা GitHub দিয়ে সাইন আপ করে থাকেন এবং কখনও পাসওয়ার্ড সেট না করে থাকেন, তবে প্রথমে "পাসওয়ার্ড ভুলে গেছেন" লিঙ্কটি ব্যবহার করুন।',
    ...
    'sub.forum_title' => 'ফোরাম অনুসরণ করুন',
    'sub.forum_following_email' => 'আপনি বর্তমানে এই ফোরামটি অনুসরণ করছেন এবং নতুন থ্রেড ও উত্তরের জন্য ইমেইল বিজ্ঞপ্তি পাবেন।',
    'sub.forum_bookmarked' => 'আপনি এই ফোরামটি বুকমার্ক করেছেন (কোনো ইমেইল বিজ্ঞপ্তি নেই)।',
    'sub.forum_not_following' => 'আপনি এই ফোরামটি অনুসরণ করছেন না।',
    'sub.back_to_forum' => 'ফোরামে ফিরে যান',
    'sub.confirm_remove_forum' => 'আপনি কি নিশ্চিত যে আপনি এই ফোরাম থেকে সাবস্ক্রিপশন বাতিল করতে চান?',
    'sub.confirm_bookmark_forum' => 'আপনার ফোরাম সাবস্ক্রিপশনকে বুকমার্কে পরিবর্তন করবেন (কোনো ইমেইল বিজ্ঞপ্তি নেই)?',
