...
return [
    ...
    'auth.pending_approval_title' => 'ماڈریٹر کی منظوری کا انتظار',
    ...
    'groups.title'             => 'گروپس',
    'groups.my_groups'         => 'میرے گروپس',
    'groups.no_memberships'    => 'آپ کسی گروپ کے رکن نہیں ہیں۔',
    'groups.col_group'         => 'گروپ',
    'groups.col_status'        => 'حیثیت',
    'groups.status_moderator'  => 'منتظم',
    'groups.status_approved'   => 'رکن',
    'groups.status_unapproved' => 'منظوری کا منتظر',
    'groups.status_suspended'  => 'معطل',
    'groups.manage'            => 'انتظام کریں',
    'groups.leave'             => 'چھوڑیں',
    'groups.joinable_groups'   => 'وہ گروپس جن میں آپ شامل ہو سکتے ہیں',
    'groups.no_joinable'       => 'اس وقت شامل ہونے کے لیے کوئی گروپ دستیاب نہیں ہے۔',
    'groups.join'              => 'شمولیت کی درخواست دیں',
    'groups.moderate_title'    => 'گروپ کا انتظام: {name}',
    'groups.pending_requests'  => 'زیر التوا درخواستیں',
    'groups.no_pending'        => 'کوئی زیر التوا درخواست نہیں۔',
    'groups.col_user'          => 'صارف',
    'groups.approve'           => 'منظور کریں',
    'groups.reject'            => 'مسترد کریں',
    'groups.members'           => 'اراکین',
    'groups.no_members'        => 'کوئی منظور شدہ رکن نہیں۔',
    'groups.suspend'           => 'معطل کریں',
    'groups.remove'            => 'ہٹا دیں',
    'groups.suspended_members' => 'معطل شدہ اراکین',
    'groups.no_suspended'      => 'کوئی معطل شدہ رکن نہیں۔',
    'groups.reinstate'         => 'بحال کریں',
    'groups.back_to_groups'    => 'گروپس پر واپس',
    ...
    'mod.users_queue'              => 'زیر التواء صارفین',
    'mod.users_queue_title'        => 'زیر التواء صارف کی منظوریاں',
    'mod.users_queue_empty'        => 'کوئی اکاؤنٹ ماڈریٹر کی منظوری کا منتظر نہیں ہے۔',
    'mod.users_queue_username'     => 'صارف نام',
    'mod.users_queue_email'        => 'ای میل',
    'mod.users_queue_ip'           => 'آئی پی ایڈریس',
    'mod.users_queue_registered'   => 'رجسٹرڈ',
    'mod.users_queue_approve'      => 'منظور کریں',
    'mod.users_queue_reject'       => 'مسترد کریں',
