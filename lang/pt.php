...
return [
    ...
    'message.ip_address'        => 'Endereço IP',
    ...
    'post.error_duplicate'       => 'Você já publicou esta mensagem recentemente.',

    // -------------------------------------------------------------------------
    // Auth
    // -------------------------------------------------------------------------
    'auth.login_title'       => 'Entrar',
    'auth.logout_title'       => 'Sair',
    'auth.logout_confirm'       => 'Tem certeza de que deseja sair?',
    'auth.logout_submit'       => 'Sair',
    'auth.logout_already'       => 'Você não está conectado.',
    ...
    'auth.confirm_success_login'        => 'Seu endereço de e-mail foi confirmado. Faça login.',
    ...
    'auth.pending_approval_title' => 'Aguardando aprovação do moderador',
    'auth.pending_approval_body'  => 'Obrigado! Sua conta agora está aguardando revisão e aprovação de um moderador. Você poderá entrar assim que isso acontecer.',
    ...
    'auth.error_throttled'  => 'Muitas tentativas. Aguarde {seconds} segundo(s) e tente novamente.',
    ...
    'auth.error_email_taken'       => 'Esse endereço de e-mail já está cadastrado. Tente fazer login ou use "Esqueceu a senha".',
    ...
    'oauth.error_account_exists'      => 'Uma conta neste site já usa esse endereço de e-mail. Faça login com sua senha, ou use "Esqueceu a senha" para confirmar o endereço primeiro — depois disso você poderá usar este provedor.',
    ...
    'settings.current_password_hint'      => 'Necessária apenas ao alterar a senha ou o endereço de e-mail.',
    ...
    'settings.email_notify'          => 'Quando eu publicar um novo tópico ou responder',
    'settings.email_notify_none'     => 'Não seguir automaticamente',
    'settings.email_notify_bookmark' => 'Seguir silenciosamente (sem e-mails)',
    ...
    'settings.error_current_password'   => 'Digite sua senha atual para alterar a senha ou o endereço de e-mail. Se você se cadastrou com Google ou GitHub e nunca definiu uma senha, use o link "Esqueceu a senha" para definir uma primeiro.',
    ...
    'settings.error_email_notify'          => 'Escolha uma opção de seguimento válida.',
    ...
    // -------------------------------------------------------------------------
    'groups.title'             => 'Grupos',
    'groups.my_groups'         => 'Meus Grupos',
    'groups.no_memberships'    => 'Você não é membro de nenhum grupo.',
    'groups.col_group'         => 'Grupo',
    'groups.col_status'        => 'Status',
    'groups.status_moderator'  => 'Moderador',
    'groups.status_approved'   => 'Membro',
    'groups.status_unapproved' => 'Aguardando aprovação',
    'groups.status_suspended'  => 'Suspenso',
    'groups.manage'            => 'Gerenciar',
    'groups.leave'             => 'Sair',
    'groups.joinable_groups'   => 'Grupos Que Você Pode Participar',
    'groups.no_joinable'       => 'No momento não há grupos disponíveis para participar.',
    'groups.join'              => 'Solicitar Participação',
    'groups.moderate_title'    => 'Gerenciar Grupo: {name}',
    'groups.pending_requests'  => 'Solicitações Pendentes',
    'groups.no_pending'        => 'Nenhuma solicitação pendente.',
    'groups.col_user'          => 'Usuário',
    'groups.approve'           => 'Aprovar',
    'groups.reject'            => 'Rejeitar',
    'groups.members'           => 'Membros',
    'groups.no_members'        => 'Nenhum membro aprovado.',
    'groups.suspend'           => 'Suspender',
    'groups.remove'            => 'Remover',
    'groups.suspended_members' => 'Membros Suspensos',
    'groups.no_suspended'      => 'Nenhum membro suspenso.',
    'groups.reinstate'         => 'Reintegrar',
    'groups.back_to_groups'    => 'Voltar aos Grupos',
    ...
    'mod.sticky_thread'            => 'Fixar tópico',
    'mod.unsticky_thread'          => 'Desafixar tópico',
    'mod.sticky_confirm'           => 'Fixar o tópico "{subject}"? Ele será fixado no topo da lista do fórum.',
    'mod.unsticky_confirm'         => 'Desafixar "{subject}"? Ele voltará à ordem normal.',
    'mod.yes_delete'               => 'Sim, excluir',
    'mod.approve'                  => 'Aprovar',
    'mod.close'                    => 'Fechar tópico',
    'mod.reopen'                   => 'Reabrir tópico',
    'mod.sticky'                   => 'Fixar',
    'mod.unsticky'                 => 'Desafixar',
    'mod.cancel'                   => 'Cancelar',
    ...
    'mod.users_queue'              => 'Usuários pendentes',
    'mod.users_queue_title'        => 'Aprovações de usuários pendentes',
    'mod.users_queue_empty'        => 'Nenhuma conta está aguardando aprovação do moderador.',
    'mod.users_queue_username'     => 'Usuário',
    'mod.users_queue_email'        => 'E-mail',
    'mod.users_queue_ip'           => 'Endereço IP',
    'mod.users_queue_registered'   => 'Registrado',
    'mod.users_queue_approve'      => 'Aprovar',
    'mod.users_queue_reject'       => 'Rejeitar',
