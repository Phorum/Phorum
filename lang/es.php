...
return [
    ...
    'thread.close'           => 'Cerrar',
    'thread.sticky'          => 'Fijar',
    'thread.unsticky'        => 'Dejar de fijar',
    'thread.move'            => 'Mover',
    ...
    'auth.pending_approval_title' => 'Esperando aprobación del moderador',
    ...
    'profile.continue_browsing' => 'Seguir navegando: {forum}',
    ...
    'groups.no_memberships'    => 'No eres miembro de ningún grupo.',
    'groups.col_group'         => 'Grupo',
    'groups.col_status'        => 'Estado',
    'groups.status_moderator'  => 'Moderador',
    'groups.status_approved'   => 'Miembro',
    'groups.status_unapproved' => 'Pendiente de aprobación',
    'groups.status_suspended'  => 'Suspendido',
    'groups.manage'            => 'Gestionar',
    'groups.leave'             => 'Salir',
    'groups.joinable_groups'   => 'Grupos a los que puedes unirte',
    'groups.no_joinable'       => 'No hay grupos disponibles para unirte en este momento.',
    'groups.join'              => 'Solicitar unirse',
    'groups.moderate_title'    => 'Gestionar grupo: {name}',
    'groups.pending_requests'  => 'Solicitudes pendientes',
    'groups.no_pending'        => 'No hay solicitudes pendientes.',
    'groups.col_user'          => 'Usuario',
    'groups.approve'           => 'Aprobar',
    'groups.reject'            => 'Rechazar',
    'groups.members'           => 'Miembros',
    'groups.no_members'        => 'No hay miembros aprobados.',
    'groups.suspend'           => 'Suspender',
    'groups.remove'            => 'Eliminar',
    'groups.suspended_members' => 'Miembros suspendidos',
    'groups.no_suspended'      => 'No hay miembros suspendidos.',
    'groups.reinstate'         => 'Restablecer',
    'groups.back_to_groups'    => 'Volver a grupos',
    ...
    'sub.forum_title' => 'Seguir foro',
    'sub.forum_following_email' => 'Actualmente sigues este foro y recibirás notificaciones por correo electrónico de nuevos temas y respuestas.',
    'sub.forum_bookmarked' => 'Has marcado este foro (sin notificaciones por correo electrónico).',
    'sub.forum_not_following' => 'No estás siguiendo este foro.',
    'sub.back_to_forum' => 'Volver al foro',
    'sub.confirm_remove_forum' => '¿Seguro que quieres cancelar la suscripción a este foro?',
    'sub.confirm_bookmark_forum' => '¿Cambiar tu suscripción del foro a un marcador (sin notificaciones por correo electrónico)?',
    ...
    'mod.sticky_thread'            => 'Fijar hilo',
    'mod.unsticky_thread'          => 'Dejar de fijar hilo',
    'mod.sticky_confirm'           => '¿Fijar el hilo "{subject}"? Se anclará en la parte superior del listado del foro.',
    'mod.unsticky_confirm'         => '¿Dejar de fijar "{subject}"? Volverá al orden normal.',
    'mod.yes_delete'               => 'Sí, eliminar',
    'mod.approve'                  => 'Aprobar',
    'mod.close'                    => 'Cerrar hilo',
    'mod.reopen'                   => 'Reabrir hilo',
    'mod.sticky'                   => 'Fijar',
    'mod.unsticky'                 => 'Dejar de fijar',
    'mod.cancel'                   => 'Cancelar',
    ...
    'mod.users_queue'              => 'Usuarios pendientes',
    'mod.users_queue_title'        => 'Aprobaciones de usuarios pendientes',
    'mod.users_queue_empty'        => 'No hay cuentas esperando aprobación del moderador.',
    'mod.users_queue_username'     => 'Usuario',
    'mod.users_queue_email'        => 'Correo electrónico',
    'mod.users_queue_ip'           => 'Dirección IP',
    'mod.users_queue_registered'   => 'Registrado',
    'mod.users_queue_approve'      => 'Aprobar',
    'mod.users_queue_reject'       => 'Rechazar',
