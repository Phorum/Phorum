...
return [
    ...
    'auth.pending_approval_title' => '等待管理员审批',
    ...
    'mod.sticky_thread'            => '置顶主题',
    'mod.unsticky_thread'          => '取消置顶主题',
    'mod.sticky_confirm'           => '将主题"{subject}"置顶？它将被固定在论坛列表顶部。',
    'mod.unsticky_confirm'         => '取消主题"{subject}"的置顶？它将恢复正常排序。',
    'mod.yes_delete'               => '确认删除',
    'mod.approve'                  => '通过',
    'mod.close'                    => '关闭主题',
    'mod.reopen'                   => '重新开放主题',
    ...
    'mod.users_queue'              => '待审用户',
    'mod.users_queue_title'        => '待审用户批准',
    'mod.users_queue_empty'        => '没有账户在等待版主批准。',
    'mod.users_queue_username'     => '用户名',
    'mod.users_queue_email'        => '邮箱',
    'mod.users_queue_ip'           => 'IP 地址',
    'mod.users_queue_registered'   => '注册时间',
    'mod.users_queue_approve'      => '批准',
    'mod.users_queue_reject'       => '拒绝',
    'report.title'                 => '举报消息',
