...
class ModerationController extends Controller
{
    ...
    public function __construct(
        ...
        $this->moderationService = $moderationService ?? new ModerationService($this->messages, $this->forums, new UserMapper(), new SubscriberMapper(), new NewflagMapper(), new FileService(new FileMapper()));
